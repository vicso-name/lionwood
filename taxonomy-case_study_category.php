<?php
/**
 * Template: Case Study — Industry taxonomy archive
 *
 * URL: /case-study/industry/{term-slug}/
...
get_template_part( 'template-parts/sections/case_hero', null, [
    ...
    'title_dark'           => get_field( 'cao_ch_title_dark',           'option' ) ?: __( 'Case', 'theme' ),
    'title_gray'           => get_field( 'cao_ch_title_gray',           'option' ) ?: __( 'Studies', 'theme' ),
...
get_template_part( 'template-parts/cases/cases-listing', null, [
    ...
    'marquee_text'         => get_field( 'cao_ccg_marquee_text',         'option' ) ?: __( 'Successful Products', 'theme' ),
...
get_template_part( 'template-parts/sections/cta_section', null, [
    ...
    'title_top'            => get_field( 'cao_cta_title_top',            'option' ) ?: __( 'Ready to Accelerate', 'theme' ),
