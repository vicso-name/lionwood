...
(function () {
    ...
    function initLoadAnim(section) {
        section.querySelectorAll('.coh-anim').forEach(function (el) {
    ...
    function initSocials(section) {
        var socialsWrap = section.querySelector('[data-coh-socials]');
        var moreBtn     = section.querySelector('[data-coh-more]');
        var closeBtn    = section.querySelector('[data-coh-close]');

        if (!socialsWrap || !moreBtn) return;

        moreBtn.addEventListener('click', function () {
            socialsWrap.classList.add('is-expanded');
            var firstHidden = socialsWrap.querySelector('.coh-socials__item--hidden');
    ...
    function init() {
        var section = document.querySelector('.coh-section');
        if (!section) return;
