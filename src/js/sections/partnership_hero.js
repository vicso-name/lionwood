/**
 * Partnership Hero — load animation + sticky button
 * Same as Home Hero but without the industry typewriter cycler.
 * File: blocks/partnership-hero/partnership-hero.js
 */
...
(function () {
  ...
  function initLoadAnim(section) {
    section.querySelectorAll('.ph-anim').forEach(function (el) {
  ...
  function init() {
    var section = document.querySelector('.ph-section');
    if (!section) return;
