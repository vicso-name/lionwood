...
(function () {
  ...
  function initEntrance(section) {
    var wrap = section.querySelector('.vs-bars');
    if (!wrap) return;

    var bars = Array.prototype.slice.call(wrap.querySelectorAll('.vs-bar'));
  ...
  function initSection(section) {
    var bars = Array.prototype.slice.call(section.querySelectorAll('.vs-bar'));
    if (!bars.length) return;
  ...
  function init() {
    document.querySelectorAll('.vs-section').forEach(function (section) {
