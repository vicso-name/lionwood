...
(function () {
  ...
  // matching statistics-animation-demo.html's entrance phase.

  function initEntrance(section) {
    var wrap = section.querySelector('.op-bars');
    if (!wrap) return;

    var bars = Array.prototype.slice.call(wrap.querySelectorAll('.op-bar'));
