...
<article class="apc-card">
    <a class="apc-card__link" href="<?php echo $permalink; ?>" aria-label="<?php echo $title; ?>">

        <div class="apc-card__image">
            <?php if ( $thumb_url ) : ?>
                <img class="apc-card__img" src="<?php echo $thumb_url; ?>" alt="<?php echo $title; ?>" loading="lazy">
            <?php endif; ?>
            <?php if ( $cat_name ) : ?>
                <div class="apc-card__tags">
                    <span class="apc-card__tag">#<?php echo $cat_name; ?></span>
                </div>
            <?php endif; ?>
        </div>

        <div class="apc-card__meta">
            <span class="apc-card__meta-date"><?php echo $date; ?></span>
        </div>

        <h3 class="apc-card__title"><?php echo $title; ?></h3>

        <?php if ( $excerpt ) : ?>
            <p class="apc-card__excerpt"><?php echo $excerpt; ?></p>
        <?php endif; ?>
