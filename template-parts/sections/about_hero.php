...
<section class="ah-section" aria-label="<?php esc_attr_e( 'About Hero', 'theme' ); ?>">
    <div class="ah-section__container">
        ...
        <h1 class="ah-heading">
            ...
            <span class="ah-heading__line ah-heading__line--1">
                <span class="ah-heading__start-group ah-anim" data-delay="0">
                    <span class="ah-heading__word ah-heading__word--start">
                        <?php echo esc_html( $line1_start ); ?>
                    </span>
                    <span class="ah-heading__arrow" aria-hidden="true">
                ...
                <span class="ah-heading__word ah-heading__word--end ah-anim" data-delay="300">
                    <?php echo esc_html( $line1_end ); ?>
                </span>
            </span>

            <?php /* Line 2: gray */ ?>
            <span class="ah-heading__line ah-heading__line--2">
                <span class="ah-heading__gray ah-anim" data-delay="450">
        ...
        <div class="ah-bottom">
            ...
            <?php if ( $description ) : ?>
                <p class="ah-description ah-anim" data-delay="600">
                    <?php echo $description; ?>
                </p>
            <?php endif; ?>

            <div class="ah-ctas ah-anim" data-delay="700">
                <a
                ...
                <a
                    class="ah-btn ah-btn--outline js-book-meeting"
