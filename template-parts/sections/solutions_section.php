        ...
        <div class="sol-section__body">
            ...
            <?php if ( ! empty( $items ) ) : ?>
                <div class="sol-col sol-col--right">
                    ...
                    <?php /*
                    .sol-cards-viewport: a no-op wrapper by default (no
                    styling, cards render in normal document flow — the
                    no-JS / no-GSAP / mobile fallback). solutions_section.js
                    turns it into a clipped, fixed-height "window" only once
                    it confirms a GSAP ScrollTrigger pin is driving the
                    section, and translates .sol-cards inside it instead of
                    relying on native page scroll.
                    */ ?>
                    <div class="sol-cards-viewport">
                    <div class="sol-cards">
                        <?php foreach ( $items as $idx => $item ) :
                            ...
                            // First card starts highlighted for the pre-JS/first-paint
                            // state (see solutions_section.js) — JS resyncs the real
                            // answer as soon as it runs.
                            $card_class = 0 === $idx ? 'sol-card is-active' : 'sol-card';
                        ?>
